...
**Google Cloud**   
This project integrates with Google Cloud services, which are governed by the [Google Cloud Terms of Service](https://cloud.google.com/terms).  All rights to Google Cloud-related trademarks, logos, and service names belong to Google LLC.  This repository does not imply endorsement or sponsorship by Google.  Users must ensure their usage complies with Google's policies and terms.   

**Terraform**   
This project uses HashiCorp Terraform in accordance with its respective [Business Source License](https://github.com/hashicorp/terraform/blob/main/LICENSE).  All rights to the Terraform name, logo, and related assets are retained by HashiCorp.  For details about its usage terms, please refer to HashiCorp’s licensing documentation.   
